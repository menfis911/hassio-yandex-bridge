...
- Обновлено описание App: теперь явно указано, что выбранные устройства добавляются в Home Assistant как отдельные устройства с собственными сущностями.
- Обновлены тексты Config Flow и Options Flow на русском и английском языках.
- Веб-панель явно обозначена как диагностическая; основное добавление устройств выполняется через интеграцию Home Assistant.
